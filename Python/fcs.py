...
def calculate_fcs(nibble_data):
    ...
    for nibble in nibble_data:
        ...
        print(f"I : {i:d} Index : 0x{index:x} CRC : 0x{crc:x}")
        i += 1
    return crc & 0xff
...
def main():
    # Exemple de données
    #nibble_data = [0x0, 0x5, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8]
    nibble_data = [0x0, 0x0, 0x5, 0x1, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0xa, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x8]
    #nibble_data = [0x0, 0x0, 0x5, 0xa, 0xc, 0xc, 0xc, 0xc, 0xc, 0xc, 0xc, 0xc, 0x1, 0x2, 0x3, 0x4]
