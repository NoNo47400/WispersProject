...
HD_PWD='D:/VIVADO_projects/MODEM_WISPER/MODEM_WISPER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MODEM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MODEM.tcl
