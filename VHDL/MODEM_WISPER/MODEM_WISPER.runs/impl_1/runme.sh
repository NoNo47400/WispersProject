...
HD_PWD='D:/VIVADO_projects/MODEM_WISPER/MODEM_WISPER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MODEM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MODEM.tcl -notrace
